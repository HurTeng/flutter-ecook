...
class MenuCategoryList extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => new MenuCategoryListState(type);
  var type = "";
  MenuCategoryList(type) {
    this.type = type;
  }
}

class MenuCategoryListState extends State<MenuCategoryList> {
...
//        print("load more ... ");
  ...
  getNewsList(bool isLoadMore) {
    String url = Api.getCategoryDishes(lastId, type);
